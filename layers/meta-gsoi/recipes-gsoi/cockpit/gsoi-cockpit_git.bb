...
SRCREV = "f773f7d471aec29655bf11f58650baeafaf258d2"
...
# Runtime: motore QML + moduli QtQuick + plugin piattaforma Wayland + SVG.
# qtsvg fornisce il plugin per caricare le icone .svg (imagehandler).
RDEPENDS:${PN} += " \
    qtbase \
    qtdeclarative \
